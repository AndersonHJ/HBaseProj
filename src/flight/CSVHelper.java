...
public class CSVHelper {
	 ...
	 */
	public static Flight generateFlight(String value){
		...
		try{
			...
			int date = Integer.parseInt(dates[dates.length - 1]);
			...
			// int airlineID, long flightDate, long depTime, int date, double arrDelayMinutes
			return new Flight(airlineId, curYear, curMonth, date, depTime, arrDelay, isCancel, isDiverted);
	...
	public static void main(String[] args) {
		...
		try {
			CSVReader reader = new CSVReader(new FileReader("/Users/houjian/Downloads/hadoopApp/data03info/On_Time_Performance_1988_10.csv"));
		    ...
		    while ((data = reader.readNext()) != null) {
				...
				//	Flight res = new Flight(airlineId, curYear, curMonth, date, depTime, arrDelay);
